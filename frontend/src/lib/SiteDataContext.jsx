...
export const FALLBACK = {
  ...
  faqs: [
    {
      id: 1,
      question: "Qanday kranlarni ta'mirlaysiz?",
      answer:
        "Ko'prikli, kozlovoy, minorali va boshqa yuk ko'taruvchi kranlarning deyarli barcha turlarini ta'mirlaymiz — joriy ta'mirdan kapital tiklashgacha.",
    },
    {
      id: 2,
      question: "Ekspertiza qancha vaqt oladi?",
      answer:
        "Obyekt hajmi va murakkabligiga qarab, sanoat xavfsizligi ekspertizasi odatda 3–10 ish kunini oladi.",
    },
    {
      id: 3,
      question: "Texnik hujjatlarni rasmiylashtirasizmi?",
      answer:
        "Ha. Pasport, texnik kartalar va boshqa barcha zarur hujjatlarni amaldagi standartlarga muvofiq tayyorlab beramiz.",
    },
    {
      id: 4,
      question: "Xizmat ko'rsatish hududi qayer?",
      answer:
        "Toshkent shahri va butun O'zbekiston bo'ylab xizmat ko'rsatamiz. Kerak bo'lsa mutaxassislarimiz obyektga chiqadi.",
    },
  ],
  settings: {
